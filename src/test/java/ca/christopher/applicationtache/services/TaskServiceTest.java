...
class TaskServiceTest {
    ...
    void testGetAllByGroup4() {
        ...
        ArrayList<Tache> tacheList = new ArrayList<>();
        tacheList.add(tache);
        when(taskRepository.findByGroupe(Mockito.<Groupe>any())).thenReturn(tacheList);
        ...
        // Act
        List<TaskDTO> actualAllByGroup = taskService.getAllByGroup(1L);

        // Assert
        verify(taskRepository).findByGroupe(Mockito.<Groupe>any());
        verify(groupeRepository).findById(Mockito.<Long>any());
        assertEquals(1, actualAllByGroup.size());
    }
    ...
    void testGetAllByGroup5() {
        ...
        Utilisateur admin5 = new Utilisateur();
        admin5.setEmail("jane.doe@example.org");
        admin5.setEvenements(new ArrayList<>());
        admin5.setGroupe(new ArrayList<>());
        admin5.setId(1L);
        admin5.setNom("Nom");
        ...
        groupe5.setAdmin(admin5);
        groupe5.setCode("Code");
        groupe5.setDescription("The characteristics of someone or something");
        groupe5.setId(1L);
        groupe5.setNom("Nom");
        groupe5.setTaches(new ArrayList<>());
        groupe5.setUtilisateurs(new ArrayList<>());
        Optional<Groupe> ofResult = Optional.of(groupe5);
        when(groupeRepository.findById(Mockito.<Long>any())).thenReturn(ofResult);
        ...
        verify(taskRepository).findByGroupe(Mockito.<Groupe>any());
        verify(groupeRepository).findById(Mockito.<Long>any());
        assertEquals(2, actualAllByGroup.size());
    }
